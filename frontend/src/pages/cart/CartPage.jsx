        ...
        <div className="px-4 py-10 max-w-7xl mx-auto min-h-screen bg-gray-50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white border border-gray-200 rounded-lg shadow-md p-6 h-fit sticky top-28 nunito">
                    ...
                    <Link to={'/checkout'} className="block text-center mt-8 w-full nunito bg-maroon text-white py-3 rounded-md font-semibold hover:opacity-90 transition">
                        Proceed to Checkout
                    </Link>

                    <div className="mt-4 text-center">
                        <Link to="/shop" className="text-blue-600 text-sm hover:underline nunito">
                            ← Continue Shopping
                        </Link>
                    </div>
                </div>
