...
const VirtualViewModal = ({ isOpen, onRequestClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        console.log("Virtual View Request:", formData);
        toast.success("Your virtual viewing request has been sent!");
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <select name="budget" onChange={handleInputChange} className="w-full p-2 border rounded-md">
                ...
                <div className="flex justify-end pt-4">
                    <button type="submit" className="px-6 py-2 bg-maroon text-white font-semibold rounded-md shadow-sm hover:bg-opacity-90 transition">
                        Request Appointment
                    </button>
                </div>
            </form>
